...
```
forge script script/DeployMarket.s.sol --rpc-url $SEPOLIA_RPC_URL --private-key $PRIVATE_KEY --broadcast --verify --etherscan-api-key $ETHERSCAN_API_KEY
```
...
or
```
forge script script/Interactions.s.sol:FundMarket --rpc-url sepolia  --private-key $PRIVATE_KEY  --broadcast
forge script script/Interactions.s.sol:WithdrawMarket --rpc-url sepolia  --private-key $PRIVATE_KEY  --broadcast
```
